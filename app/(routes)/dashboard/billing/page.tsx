...
export default function PricingPage() {
  return (
    <>
     <div className="w-full flex items-center justify-between px-4 md:px-14 py-1 font-medium text-sm text-white text-center bg-gradient-to-r from-blue-500 to-purple-600 mb-6">
